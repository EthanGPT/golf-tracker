...
export const HERMANUS_WHITE_DISTANCES = [312, 460, 394, 146, 357, 480, 371, 329, 136, 332, 433, 360, 150, 320, 327, 155, 446, 283, 398, 347, 124, 476, 329, 139, 311, 302, 488] as const
export const HERMANUS_TEE_DISTANCES = {
  yellow: [326, 466, 412, 169, 363, 493, 394, 352, 144, 348, 468, 384, 158, 326, 337, 163, 464, 299, 425, 361, 142, 489, 343, 148, 342, 320, 531],
  white: HERMANUS_WHITE_DISTANCES,
  red: [270, 379, 338, 114, 283, 398, 320, 284, 110, 302, 375, 297, 110, 270, 283, 114, 380, 246, 329, 290, 96, 425, 261, 110, 252, 251, 434],
} as const
export const holeDistance = (hole: number, tee: Tee = 'white') => HERMANUS_TEE_DISTANCES[tee][hole - 1] || 0
