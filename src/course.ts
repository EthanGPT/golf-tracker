...
export const ZIMBALI_LAKES_COURSE = scorecardCourse({
  ...
  distances: {
    ...
    blue: yardsToMetres([350, 223, 464, 136, 282, 311, 136, 439, 291, 218, 335, 206, 416, 128, 272, 388, 134, 304]),
    red: yardsToMetres([330, 197, 407, 126, 256, 295, 113, 427, 275, 184, 308, 181, 389, 101, 265, 376, 97, 280]),
  },
});
